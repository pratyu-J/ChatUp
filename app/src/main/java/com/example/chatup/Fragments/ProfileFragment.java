...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        profilePicture = v.findViewById(R.id.profile_pic_set);
        profileUsername = v.findViewById(R.id.username_set);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(user.getImageUrl().equals("default")){
                    profilePicture.setImageResource(R.drawable.person_vector);
                }
                else {
    ...
    public void uploadImage(){
        ...
        if(imageUri != null){
            final StorageReference fileref = storage.child(System.currentTimeMillis() + "." + getFileExtention(imageUri));
